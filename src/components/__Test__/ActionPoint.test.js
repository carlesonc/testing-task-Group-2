...
describe("Test 'renderExternalLink()'", () => {
  it("renders External link text correctly", () => {
    const wrapper = shallow(<ActionPoint linkKind={1} title="External link" />);
    expect(wrapper.find("a").text()).toBe("External link");
  });
  it("renders href correctly", () => {
    const wrapper = shallow(<ActionPoint linkKind={1} linkExternal="External link" />);
...
describe("Test 'renderInternalLink()'", () => {
  it("renders Internal link text correctly based on UserContext", () => {
    ...
    expect(wrapper.find("a").at(1).text()).toBe("Internal link visited by johndoe");
  });
...
describe("Test 'renderModalLink()'", () => {
  it("renders Modal link text correctly", () => {
    const wrapper = shallow(<ActionPoint linkKind={2} title="Modal Link" />);
  ...
  // })
  //	Modal link does not recieve any href-prop.
});

describe("Test 'renderDocumentLink()'", () => {
  it("renders Document link text correctly", () => {
    const wrapper = shallow(<ActionPoint linkKind={3} title="Document Link" />);
    expect(wrapper.find("a").text()).toBe("Document Link");
  });
  it("renders href correctly", () => {
    const wrapper = shallow(<ActionPoint linkKind={3} linkDocument="linkDocument" />);
...
describe("Test styling props", () => {
  it("renders correct styling", () => {
    const wrapper = shallow(<ActionPoint linkKind={2} top={10} left={10} />);
